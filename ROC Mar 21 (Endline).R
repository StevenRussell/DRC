...
# Note : re-save (and import data at some point) to incoporate possible changes

# Importing observation data

  obs <- read.csv("//cdc.gov/private/L330/ykf1/New folder/DRC/R2HC_data_10Jan2017 (Observation Endline data).csv",
...
# Importing interview data
  ...
  ints <- read.csv("//cdc.gov/private/L330/ykf1/New folder/DRC/R2HC_data_10Jan2017 (Interview Endline data).csv", 
...
# Importing partograph data
  ...
  part <- read.csv("//cdc.gov/private/L330/ykf1/New folder/DRC/R2HC_data_10Jan2017 (Observation Partograph data).csv",
...
recode(obs_ints$i_Q202_tension, Ndiyo = "oui", Apana = "non")
...
AUC1 <- function(var1, var2) {
                ...
                #var1 <- recode(var1, Ndiyo = "oui", Apana = "non")
...
p <-  print(xtable(df, align=replicate(10, "center")), type="html")
